 ...
 * @version 2.0.0
 */
public class CSharpFileBuilder extends FileBuilder {

  /**
   * Constructs a new CSharpFileBuilder contained by the provided LanguageProvider
   *
   * @param provider The LanguageProvider containing this FileBuilder
   */
  public CSharpFileBuilder(@NonNull LanguageProvider provider) {
    super(provider);
  }
