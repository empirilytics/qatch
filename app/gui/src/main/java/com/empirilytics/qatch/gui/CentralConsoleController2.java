package com.empirilytics.qatch.gui;
...
import com.empirilytics.qatch.core.OptimalParallelBenchmarkAnalyzer;
 ...
 * @version 1.0.0
 */
public class CentralConsoleController2 {
    ...
    @FXML
    public ProgressBar prog7;
    @FXML
    public ProgressBar prog8;
    @FXML
    public ProgressBar prog9;
    @FXML
    public ProgressBar prog10;
    ...
    @FXML
    private ProgressIndicator progInd7;
    @FXML
    private ProgressIndicator progInd8;
    @FXML
    private ProgressIndicator progInd9;
    @FXML
    private ProgressIndicator progInd10;
    ...
    public CentralConsoleController2(){
    ...
    public void initialize() throws InterruptedException {
        ...
        progIndicators.add(progInd7);
        progIndicators.add(progInd8);
        progIndicators.add(progInd9);
        progIndicators.add(progInd10);

        // Set the threshold of the depth
        int threshold;
